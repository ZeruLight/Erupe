...
func handleMsgMhfEnumeratePrice(s *Session, p mhfpacket.MHFPacket) {
	...
	var priceData = []PriceStruct{
		{0, 1000, 0, 0x0073, 100, 1},
		{0, 800, 0, 0x0006, 100, 1},
		{0, 800, 0, 0x0030, 100, 1},
		{0, 1100, 0, 0x0072, 100, 1},
		{0, 900, 0, 0x0034, 100, 1},
		{0, 900, 0, 0x0014, 100, 1},
		{0, 1300, 0, 0x006E, 100, 1},
		{0, 1000, 0, 0x0016, 100, 1},
		{0, 1000, 0, 0x0001, 100, 1},
		{0, 800, 0, 0x0043, 100, 1},
		{0, 1400, 0, 0x006F, 100, 1},
		{0, 900, 0, 0x0033, 100, 1},
		{0, 1100, 0, 0x000B, 100, 1},
		{0, 1000, 0, 0x000F, 100, 1},
		{0, 1600, 0, 0x0070, 100, 1},
		{0, 1100, 0, 0x0011, 100, 1},
		{0, 1400, 0, 0x004C, 100, 1},
		{0, 1000, 0, 0x0059, 100, 1},
		{0, 1700, 0, 0x006D, 100, 1},
		{0, 1500, 0, 0x004B, 100, 1},
		{0, 1500, 0, 0x0050, 100, 1},
		{0, 1600, 0, 0x0035, 100, 1},
		{0, 1800, 0, 0x006C, 100, 1},
		{0, 1100, 0, 0x0028, 100, 1},
		{0, 1500, 0, 0x0053, 100, 1},
		{0, 1600, 0, 0x0060, 100, 1},
		{0, 1500, 0, 0x005E, 100, 1},
		{0, 1300, 0, 0x007B, 100, 1},
		{0, 1000, 0, 0x0074, 100, 1},
		{0, 1800, 0, 0x006B, 100, 1},
		{0, 600, 0, 0x001B, 100, 1},
		{0, 600, 0, 0x001C, 100, 1},
		{0, 700, 0, 0x001F, 100, 1},
		{0, 1700, 0, 0x0079, 100, 1},
		{0, 800, 0, 0x0008, 100, 1},
		{0, 1000, 0, 0x0015, 100, 1},
		{0, 1800, 0, 0x007A, 100, 1},
		{0, 1100, 0, 0x000E, 100, 1},
		{0, 1600, 0, 0x0055, 100, 1},
		{0, 2000, 0, 0x0002, 100, 1},
		{0, 1500, 0, 0x002F, 100, 1},
		{0, 1600, 0, 0x002A, 100, 1},
		{0, 1900, 0, 0x007E, 100, 1},
		{0, 700, 0, 0x0044, 100, 1},
		{0, 900, 0, 0x005C, 100, 1},
		{0, 1600, 0, 0x005B, 100, 1},
		{0, 1700, 0, 0x007D, 100, 1},
		{0, 1900, 0, 0x007F, 100, 1},
		{0, 1500, 0, 0x0054, 100, 1},
		{0, 1600, 0, 0x0029, 100, 1},
		{0, 2400, 0, 0x0024, 100, 1},
		{0, 2000, 0, 0x0081, 100, 1},
		{0, 2100, 0, 0x0080, 100, 1},
		{0, 900, 0, 0x001A, 100, 1},
		{0, 1000, 0, 0x002D, 100, 1},
		{0, 900, 0, 0x004A, 100, 1},
		{0, 1700, 0, 0x005A, 100, 1},
		{0, 900, 0, 0x0027, 100, 1},
		{0, 1800, 0, 0x0083, 100, 1},
		{0, 1900, 0, 0x0040, 100, 1},
		{0, 1600, 0, 0x0069, 100, 1},
		{0, 1100, 0, 0x0025, 100, 1},
		{0, 1200, 0, 0x0031, 100, 1},
		{0, 1800, 0, 0x0082, 100, 1},
		{0, 1000, 0, 0x0065, 100, 1},
		{0, 1600, 0, 0x0051, 100, 1},
		{0, 2000, 0, 0x008C, 100, 1},
		{0, 1800, 0, 0x004D, 100, 1},
		{0, 900, 0, 0x004E, 100, 1},
		{0, 2200, 0, 0x008B, 100, 1},
		{0, 1200, 0, 0x002E, 100, 1},
		{0, 2400, 0, 0x0092, 100, 1},
		{0, 1900, 0, 0x008E, 100, 1},
		{0, 1300, 0, 0x0068, 100, 1},
		{0, 1200, 0, 0x002B, 100, 1},
		{0, 1000, 0, 0x002C, 100, 1},
		{0, 3000, 0, 0x0093, 100, 1},
		{0, 2300, 0, 0x0090, 100, 1},
		{0, 2800, 0, 0x0094, 100, 1},
		{0, 1700, 0, 0x008D, 100, 1},
		{0, 1100, 0, 0x0052, 100, 1},
		{0, 1500, 0, 0x004F, 100, 1},
		{0, 2200, 0, 0x0097, 100, 1},
		{0, 1800, 0, 0x006A, 100, 1},
		{0, 1600, 0, 0x005F, 100, 1},
		{0, 900, 0, 0x0026, 100, 1},
		{0, 2300, 0, 0x0096, 100, 1},
		{0, 2000, 0, 0x0098, 100, 1},
		{0, 1900, 0, 0x0041, 100, 1},
		{0, 1700, 0, 0x003B, 100, 1},
		{0, 1800, 0, 0x0036, 100, 1},
		{0, 2100, 0, 0x009F, 100, 1},
		{0, 2600, 0, 0x009A, 100, 1},
		{0, 1900, 0, 0x0021, 100, 1},
		{0, 2000, 0, 0x0063, 100, 1},
		{0, 2700, 0, 0x0099, 100, 1},
		{0, 2200, 0, 0x009E, 100, 1},
		{0, 1800, 0, 0x00A1, 100, 1},
		{0, 3100, 0, 0x00A2, 100, 1},
		{0, 3200, 0, 0x00A4, 100, 1},
		{0, 3500, 0, 0x00A6, 100, 1},
		{0, 3200, 0, 0x00A5, 100, 1},
	}
	bf := byteframe.NewByteFrame()
