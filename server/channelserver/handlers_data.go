...
func dumpSaveData(s *Session, data []byte, suffix string) {
	if !s.server.erupeConfig.DevModeOptions.SaveDumps.Enabled {
		...
		path := filepath.Join(s.server.erupeConfig.DevModeOptions.SaveDumps.OutputDir, fmt.Sprintf("%d", s.charID), fmt.Sprintf("%d%s.bin", s.charID, suffix))
		_, err := os.Stat(dir)
		if err != nil {
...
func handleMsgMhfLoaddata(s *Session, p mhfpacket.MHFPacket) {
	...
	if _, err := os.Stat(filepath.Join(s.server.erupeConfig.BinPath, "saveoverride.bin")); err == nil {
		data, _ := os.ReadFile(filepath.Join(s.server.erupeConfig.BinPath, "saveoverride.bin"))
...
var paperGiftData = map[uint32][]PaperGift{
	6001: {
		{uint16(mhf.Couragegem), 1, 1, 5000},
		{uint16(mhf.GlitteringGem), 1, 1, 3350},
		{uint16(mhf.DivineGem), 1, 1, 1500},
		{uint16(mhf.PulsatingLiquid), 1, 1, 100},
		{uint16(mhf.AncientGoldShard), 1, 1, 50},
	},
	6002: {
		{uint16(mhf.Couragegem), 2, 1, 1800},
		{uint16(mhf.GlitteringGem), 2, 1, 1200},
		{uint16(mhf.DivineGem), 2, 1, 500},
		{uint16(mhf.PulsatingLiquid), 1, 1, 50},
		{uint16(mhf.RecSpeedGemI), 1, 1, 150},
		{11038, 1, 1, 150},
		{11044, 1, 1, 150},
		{11057, 1, 1, 150},
		{11059, 1, 1, 150},
	...
	6010: {
		{uint16(mhf.Couragegem), 1, 1, 3700},
		{uint16(mhf.GlitteringGem), 1, 1, 2900},
		{11161, 1, 1, 1300},
		{11453, 1, 1, 250},
		{11454, 1, 1, 250},
		{12055, 1, 1, 250},
	...
	6012: {
		{uint16(mhf.Couragegem), 2, 1, 3500},
		{uint16(mhf.GlitteringGem), 2, 1, 2900},
		{11161, 2, 1, 1300},
		{12508, 1, 1, 400},
		{11453, 1, 1, 200},
		{11454, 1, 1, 200},
	...
	7001: {
		{uint16(mhf.RecSpeedGemI), 1, 1, 290},
		{11038, 1, 1, 270},
		{11044, 1, 1, 270},
		{11057, 1, 1, 290},
		{11059, 1, 1, 290},
		...
		{11124, 1, 1, 17},
		{11090, 1, 1, 17},
		{uint16(mhf.Couragegem), 1, 1, 1200},
		{uint16(mhf.Couragegem), 2, 1, 650},
		{uint16(mhf.GlitteringGem), 1, 1, 800},
		{uint16(mhf.GlitteringGem), 2, 1, 300},
		{11161, 1, 1, 100},
		{11161, 2, 1, 50},
		{11164, 1, 1, 100},
		{11162, 1, 1, 100},
		{uint16(mhf.AncientGoldShard), 1, 1, 100},
		{11158, 1, 1, 300},
		{11463, 1, 1, 300},
		{11356, 1, 1, 300},
		{11464, 1, 1, 300},
		...
		{11082, 1, 2, 47},
		{11103, 1, 2, 47},
		{uint16(mhf.HearingProtGemII), 1, 2, 47},
		{11112, 1, 2, 47},
		{11114, 1, 2, 47},
		{11115, 1, 2, 47},
		{11121, 1, 2, 47},
		...
		{11056, 1, 2, 16},
		{11092, 1, 2, 16},
		{uint16(mhf.Couragegem), 1, 2, 1200},
		{uint16(mhf.Couragegem), 2, 2, 650},
		{uint16(mhf.GlitteringGem), 1, 2, 800},
		{uint16(mhf.GlitteringGem), 2, 2, 300},
		{11161, 1, 2, 100},
		{11161, 2, 2, 50},
		{11164, 1, 2, 100},
		{11162, 1, 2, 100},
		{uint16(mhf.AncientGoldShard), 1, 2, 100},
		{11158, 1, 2, 300},
		{11463, 1, 2, 300},
		{11356, 1, 2, 300},
		{11464, 1, 2, 300},
		...
		{10813, 1, 3, 375},
		{11389, 1, 3, 375},
		{uint16(mhf.Couragegem), 1, 3, 1000},
		{uint16(mhf.Couragegem), 2, 3, 250},
		{uint16(mhf.GlitteringGem), 1, 3, 700},
		{uint16(mhf.GlitteringGem), 2, 3, 175},
		{11161, 1, 3, 300},
		{11161, 2, 3, 75},
		{11465, 1, 3, 53},
		{11466, 1, 3, 27},
	...
	7002: {
		{uint16(mhf.RecSpeedGemI), 1, 1, 100},
		{11038, 1, 1, 100},
		{11044, 1, 1, 100},
		{11057, 1, 1, 100},
		{11059, 1, 1, 100},
		...
		{11164, 1, 1, 400},
		{11162, 1, 1, 200},
		{uint16(mhf.AncientGoldShard), 1, 1, 200},
		{11463, 1, 1, 100},
		{11464, 1, 1, 150},
		{10355, 1, 1, 150},
		{12506, 1, 1, 200},
		...
		{12016, 1, 1, 400},
		{12015, 1, 1, 410},
		{uint16(mhf.Couragegem), 2, 1, 500},
		{uint16(mhf.Couragegem), 4, 1, 500},
		{uint16(mhf.Couragegem), 6, 1, 500},
		{uint16(mhf.GlitteringGem), 2, 1, 400},
		{uint16(mhf.GlitteringGem), 4, 1, 400},
		{uint16(mhf.GlitteringGem), 6, 1, 400},
		{11161, 2, 1, 100},
		{11161, 4, 1, 100},
		{11161, 6, 1, 100},
		{11039, 1, 2, 100},
		...
		{11082, 1, 2, 60},
		{11103, 1, 2, 60},
		{uint16(mhf.HearingProtGemII), 1, 2, 60},
		{11112, 1, 2, 60},
		{11114, 1, 2, 60},
		{11115, 1, 2, 60},
		{11121, 1, 2, 60},
		...
		{11164, 1, 2, 400},
		{11162, 1, 2, 200},
		{uint16(mhf.AncientGoldShard), 1, 2, 200},
		{11463, 1, 2, 250},
		{11464, 1, 2, 350},
		{12506, 1, 2, 150},
		{12507, 1, 2, 200},
		...
		{12016, 1, 2, 450},
		{12015, 1, 2, 460},
		{uint16(mhf.Couragegem), 2, 2, 500},
		{uint16(mhf.Couragegem), 4, 2, 500},
		{uint16(mhf.Couragegem), 6, 2, 500},
		{uint16(mhf.GlitteringGem), 2, 2, 400},
		{uint16(mhf.GlitteringGem), 4, 2, 400},
		{uint16(mhf.GlitteringGem), 6, 2, 400},
		{11161, 2, 2, 100},
		{11161, 4, 2, 100},
		{11161, 6, 2, 100},
		{11041, 1, 3, 120},
		...
		{12046, 3, 3, 500},
		{12503, 3, 3, 500},
		{uint16(mhf.Couragegem), 2, 3, 500},
		{uint16(mhf.Couragegem), 4, 3, 500},
		{uint16(mhf.Couragegem), 6, 3, 500},
		{uint16(mhf.GlitteringGem), 2, 3, 400},
		{uint16(mhf.GlitteringGem), 4, 3, 400},
		{uint16(mhf.GlitteringGem), 6, 3, 400},
		{11161, 2, 3, 100},
		{11161, 4, 3, 100},
		{11161, 6, 3, 100},
		{11465, 1, 3, 53},
...
func handleMsgMhfGetPaperData(s *Session, p mhfpacket.MHFPacket) {
	...
	case 5:
		paperData = []PaperData{
			...
			{1010, 1, 4000, 0, 0, 0, 0},
			{1010, 2, 4000, 0, 0, 0, 0},
			// updatedispflag / getPaperDataSetParam1
			...
			// setServerZako
			{1015, 1, int16(mhf.Velociprey), int16(mhf.Velociprey), int16(mhf.Velociprey), 0, 0},
			{1015, 2, int16(mhf.Velociprey), int16(mhf.Velociprey), int16(mhf.Velociprey), 0, 0},
			...
			{1105, 2, 10, 500, 0, 0, 0},
			// setServerBoss
			{2001, 1, int16(mhf.Gravios), 58, 0, 6, 700},
			{2001, 1, int16(mhf.Gypceros), 58, 0, 3, 200},
			{2001, 1, int16(mhf.Basarios), 58, 0, 7, 250},
			{2001, 1, int16(mhf.Velocidrome), 58, 0, 1, 100},
			{2001, 1, int16(mhf.Rajang), 58, 0, 8, 1000},
			{2001, 1, int16(mhf.ShogunCeanataur), 58, 0, 9, 500},
			{2001, 1, int16(mhf.Bulldrome), 58, 0, 2, 150},
			{2001, 1, int16(mhf.Hypnocatrice), 58, 0, 4, 200},
			{2001, 1, int16(mhf.Lavasioth), 58, 0, 5, 500},
			{2001, 1, int16(mhf.BrightHypnoc), 58, 0, 10, 800},
			{2001, 1, int16(mhf.Espinas), 58, 0, 11, 900},
			{2001, 1, int16(mhf.AkuraJebia), 58, 0, 12, 600},
			{2001, 2, int16(mhf.Gravios), 60, 0, 6, 700},
			{2001, 2, int16(mhf.Gypceros), 60, 0, 3, 200},
			{2001, 2, int16(mhf.Basarios), 60, 0, 7, 350},
			{2001, 2, int16(mhf.Velocidrome), 60, 0, 1, 100},
			{2001, 2, int16(mhf.PurpleGypceros), 60, 0, 13, 200},
			{2001, 2, int16(mhf.YianGaruga), 60, 0, 15, 600},
			{2001, 2, int16(mhf.Rajang), 60, 0, 8, 1000},
			{2001, 2, int16(mhf.ShogunCeanataur), 60, 0, 2, 500},
			{2001, 2, int16(mhf.Bulldrome), 60, 0, 9, 150},
			{2001, 2, int16(mhf.Hypnocatrice), 60, 0, 4, 200},
			{2001, 2, int16(mhf.Lavasioth), 60, 0, 5, 500},
			{2001, 2, int16(mhf.Tigrex), 60, 0, 10, 800},
			{2001, 2, int16(mhf.Espinas), 60, 0, 11, 900},
			{2001, 2, int16(mhf.OrangeEspinas), 60, 0, 14, 900},
			{2001, 2, int16(mhf.Pariapuria), 60, 0, 12, 600},
			{2001, 2, int16(mhf.Dyuragaua), 60, 0, 16, 1000},
		}
	case 6:
		paperData = []PaperData{
			...
			{4001, 1, 0, 0, 0, 0, 0},
			{4001, 2, 0, int16(mhf.TowerPotion), 5, 0, 1},
			{4001, 2, 0, int16(mhf.TowerPotion), 5, 0, 1},
			{4001, 2, 0, int16(mhf.TowerPotion), 5, 0, 1},
			{4001, 2, 0, int16(mhf.TowerPotion), 5, 0, 1},
			{4001, 2, 0, int16(mhf.TowerMegaPotion), 2, 0, 1},
			{4001, 2, 0, int16(mhf.TowerMegaPotion), 2, 0, 1},
			{4001, 2, 0, int16(mhf.TowerMegaPotion), 2, 0, 1},
			{4001, 2, 0, int16(mhf.TowerMegaPotion), 2, 0, 1},
			{4001, 2, 0, int16(mhf.TowerMaxPotion), 1, 0, 1},
			{4001, 2, 0, int16(mhf.TowerMaxPotion), 1, 0, 1},
			{4001, 2, 0, int16(mhf.TowerMaxPotion), 1, 0, 1},
			{4001, 2, 0, int16(mhf.TowerMaxPotion), 1, 0, 1},
			...
			{4005, 1, 0, int16(mhf.Couragegem), 1, 5000, 1},
			{4005, 1, 0, int16(mhf.GlitteringGem), 1, 3350, 1},
			{4005, 1, 0, 11161, 1, 1500, 1},
			{4005, 1, 0, 11162, 1, 100, 1},
			{4005, 1, 0, int16(mhf.AncientGoldShard), 1, 50, 1},
			{4005, 2, 0, int16(mhf.Couragegem), 2, 1800, 1},
			{4005, 2, 0, int16(mhf.GlitteringGem), 2, 1200, 1},
			{4005, 2, 0, 11161, 2, 500, 1},
			{4005, 2, 0, 11162, 1, 50, 1},
			{4005, 2, 0, int16(mhf.RecSpeedGemI), 1, 150, 1},
			...
			{4006, 1, 0, int16(mhf.Couragegem), 1, 5000, 1},
			{4006, 1, 0, int16(mhf.GlitteringGem), 1, 3350, 1},
			{4006, 1, 0, 11161, 1, 1500, 1},
			{4006, 1, 0, 11162, 1, 100, 1},
			{4006, 1, 0, int16(mhf.AncientGoldShard), 1, 50, 1},
			{4006, 2, 0, int16(mhf.Couragegem), 2, 1800, 1},
			{4006, 2, 0, int16(mhf.GlitteringGem), 2, 1200, 1},
			{4006, 2, 0, 11161, 2, 500, 1},
			{4006, 2, 0, 11162, 1, 50, 1},
			{4006, 2, 0, int16(mhf.RecSpeedGemI), 1, 150, 1},
			...
			{4007, 1, 0, int16(mhf.HearingProtGemII), 1, 70, 1},
			...
			{4007, 2, 0, int16(mhf.HearingProtGemII), 1, 90, 1},
			...
			{4007, 2, 0, int16(mhf.Couragegem), 3, 1220, 1},
			{4007, 2, 0, int16(mhf.GlitteringGem), 3, 650, 1},
			{4007, 2, 0, 11161, 3, 160, 1},
			{4007, 2, 0, 11661, 1, 800, 1},
			{4007, 2, 0, 11662, 1, 800, 1},
			{4007, 2, 0, int16(mhf.AncientGoldShard), 1, 500, 1},
			...
			{4202, 1, 0, int16(mhf.AncientGoldShard), 1, 6000, 1},
			...
			{4202, 2, 0, int16(mhf.AncientGoldShard), 1, 400, 1},
